...
const LangCenters = () =>{
    return <>
        ...
        <Typography className="text-xl mt-20 mb-5 flex items-center justify-between font-bold capitalize font-main text-start text-mainBleu underline rounded px-4 h-max">
          ...
          <Typography className="text-xl px-4 flex font-normal items-center justify-between capitalize font-main text-start text-black rounded max-w-[1000px] h-max">
            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Facilis quidem odit rem eius molestiae fuga illum hic nostrum itaque eum cumque deleniti voluptate, pariatur ullam veniam nobis! Harum, repellat vel.
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Similique fugit eaque assumenda labore odit. Asperiores corrupti velit est natus nobis exercitationem temporibus perspiciatis itaque. Quisquam tempore animi numquam! Alias, provident.
          </Typography>
          <Box component={'div'} className="h-16 flex gap-x-2 items-center justify-between px-2  bg-mainBleu mt-12 rounded max-w-[620px] ml-auto">
          <Autocomplete
      disablePortal
      id="combo-box-demo"
      options={top100Films}
    ...
    />
     <Autocomplete
      ...
      renderInput={(params) => <TextField {...params} label="Movie" />}
    />
    <Button startIcon={<Search />} className="flex item-center bg-yellow text-white justify-center min-h-14">
