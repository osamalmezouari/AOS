...
const UpdateEstivage: React.FC = () => {
    ...
    const fetchtargetdemande = async () => {
      try {
        ...
        setFormState((prevState) => ({
          ...
          type: data.type,
          datedebut: data.date_entre,
          datefin: data.date_sortie,
  ...
  return (
    <div className="bg-landing h-screen">
      ...
      <Container
        maxWidth="sm"
        className="flex items-center justify-center mt-10 h-screen"
      >
        <CssBaseline />
        <Box
          sx={{
        ...
        >
          ...
          >
            Modification de Demande d'Estivage
          </Typography>
          <Box
            component="form"
            sx={{ mt: 3 }}
