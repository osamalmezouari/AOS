...
export class TypeCondoleanceController {
  constructor(private readonly typeCondoleanceService: TypeCondoleanceService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateTypeCondoleanceDto: UpdateTypeCondoleanceDto) {
